...
Please generate all required fields including overview, learning objectives, prerequisites, duration, sessions per week, total projects, max students, and value propositions. Use the detailed course description to create accurate and specific learning objectives and value propositions that reflect the actual course content."""
            ...
            result = {
                ...
                'duration_weeks': parsed_data.get('duration_weeks', 8),
                'sessions_per_week': parsed_data.get('sessions_per_week', 2),
                'total_projects': parsed_data.get('total_projects', 5),
                'max_students': parsed_data.get('max_students', 12),
