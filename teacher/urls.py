...
urlpatterns = [
    ...
    path(
        ...
        StaffTeacherRosterDetailView.as_view(),
        name='staff_teacher_roster_detail',
    ),
    ...
    path(
        'staff/teachers/<int:teacher_id>/dialog/',
        StaffTeacherDialogApiView.as_view(),
        name='staff_teacher_dialog',
    ),
    ...
    path(
        'courses/<uuid:course_id>/ai/prompts/<str:kind>/',
        views.CourseTeacherPromptView.as_view(),
        name='course_teacher_prompt',
    ),
